...
export default function Listing() {
    ...
    return (
        <main>
            ...
            {error && (<p className='text-center text-red-400 my-7 text-2xl'>Something went wrong</p>)}
            {listing && !loading && !error && (
                ...
                <div>
                    ...
                    <div className='flex flex-col max-w-4xl mx-auto p-3 my-7'>
                        ...
                        <p className='flex items-center mt-6 gap-2 text-blue-400 my-2 text-sm'>
                        ...
                        <div className='flex gap-4'>
                            ...
                            {
                                listing.offer && (
                                    <p className='bg-green-400 w-full max-w-[200px] text-white text-center p-1 rounded-md'>${+listing.regularPrice - +listing.discountPrice}</p>
                                )
                            }
                        </div>
                        ...
                        {currentUser && listing.userRef !== currentUser._id && !contact && (
                            <button onClick={() => setContact(true)} className='bg-blue-500 text-white rounded-lg uppercase hover:opacity-95'>Contact Landload</button>
                        )}
